...
_World = World.prototype

_World.start = function () {
...
_World.init_canvas = function (width, height) {
...
_World.update_canvas_size = function (width, height) {
  this.canvas.width = width
  this.canvas.height = height
  this.context = this.canvas.getContext('2d')
}

_World.clear = function () {
  this.context.clearRect(0, 0, this.screen.width,
			this.screen.height - this.game_menu.menu_height)
}

_World.game_loop = function () {
  if (g_running) {
...
*/
_World.world_2_map_coords = function (e) {
